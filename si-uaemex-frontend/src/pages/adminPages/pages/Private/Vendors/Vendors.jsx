...
import { AppstoreAddOutlined, FilterOutlined, UserAddOutlined } from '@ant-design/icons';
...
const Vendors = () => {
  ...
  return (
    <div className="container mt-5">
      <div className="row">
        {isDesktop ? (
          <div className="col-12 col-md-3">
            ...
            >
              <AppstoreAddOutlined />{t('addVendor')}
            </Button>
      ...
      <GeneralModal
        title={<div className='d-flex gap-4'><AppstoreAddOutlined style={{ color: "#1971a4" }} /><h5 className='mt-1'>{t('AddClinicTitle')}</h5></div>}
