...
import { deleteClinicThunk, getVendorsListThunk } from '../../../../../../store/slices/Admin/customers/customers-vendorsModule.slice';
...
const UsersTable = () => {
  ...
  const handleDeleteUser = (key) => {
    const clinicDeletedMsg = t("clinicDeletedMsg")
    console.log(key)
    dispatch(deleteClinicThunk(key, clinicDeletedMsg));
  };
